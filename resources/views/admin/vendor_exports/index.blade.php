    ...
    $('#start-export').on('click', function(){
        ...
        $.ajax({
            ...
            success: async function(data){
                ...
                worksheet.addRow([
                    'ID','Name','Email','Phone','Store Name','GST No',
                    'Pincode','Address','Status','Is Verified',
                    'Approved Products','Pending Products','Created At'
                ]);
                ...
                for (const row of data) {
                    ...
                    // Yield to the browser so UI updates (important for large data)
                    await new Promise(resolve => setTimeout(resolve, 10));
                }

                $('#export-status').text('Preparing download...');
