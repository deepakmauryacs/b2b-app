                        ...
                        <div class="dropdown topbar-item">
                            ...
                            <div class="dropdown-menu py-0 dropdown-lg dropdown-menu-end"
                                ...
                                <div data-simplebar style="max-height: 280px;">
                                    @foreach ([['name' => 'Josephine Thompson', 'avatar' => 'avatar-1.jpg', 'message' => 'commented on admin panel <span>" Wow 😍! this admin looks good and awesome design"</span>'], ['name' => 'Donoghue Susan', 'avatar' => 'D', 'message' => 'Hi, How are you? What about our next meeting'], ['name' => 'Jacob Gines', 'avatar' => 'avatar-3.jpg', 'message' => 'Answered to your comment on the cash flow forecast\'s graph 🔔.'], ['name' => null, 'avatar' => 'iconamoon:comment-dots-duotone', 'message' => 'You have received <b>20</b> new messages in the conversation'], ['name' => 'Shawn Bunch', 'avatar' => 'avatar-5.jpg', 'message' => 'Commented on Admin']] as $notification)
                                        <a href="javascript:void(0);"
                                            class="dropdown-item py-3 border-bottom text-wrap">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    @if (strpos($notification['avatar'], '.jpg') !== false)
                                                        <img src="{{ asset('assets/images/users/' . $notification['avatar']) }}"
                                                            class="img-fluid me-2 avatar-sm rounded-circle"
                                                            alt="{{ $notification['avatar'] }}" />
                                                    @else
                                                        <div class="avatar-sm me-2">
                                                            <span
                                                                class="avatar-title bg-soft-{{ $notification['avatar'] == 'D' ? 'info text-info' : 'warning text-warning' }} fs-20 rounded-circle">
                    ...
                    <div class="p-3 settings-bar">
                        ...
                        <div>
                            ...
                            <div class="form-check mb-2">
                                ...
                                <label class="form-check-label" for="leftbar-size-small-hover-active">Small Hover
                                    Active</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="data-menu-size"
                        ...
                        <div class="collapse" id="sidebarCategory">
                            <ul class="nav sub-navbar-nav">
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="{{ route('admin.categories.index') }}">Category
                                        List</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 text-center">
                            ...
                            </script> © Larkon. Crafted by <iconify-icon icon="iconamoon:heart-duotone"
