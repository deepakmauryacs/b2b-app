                    ...
                    <div class="row gy-3">
                        <div class="col-md-12">
                            ...
                            @if($banner->banner_img)
                                <div class="mt-2">
                                    <img src="{{ asset($banner->banner_img) }}" alt="Banner" style="max-height:60px;">
                                </div>
                            @endif
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="banner_start_date" id="banner_start_date" class="form-control" 
                                value="{{ old('banner_start_date', $banner->banner_start_date ? \Carbon\Carbon::parse($banner->banner_start_date)->format('d-m-Y') : '') }}" 
                                placeholder="dd-mm-yyyy">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">End Date</label>
                            <input type="text" name="banner_end_date" id="banner_end_date" class="form-control" 
                                value="{{ old('banner_end_date', $banner->banner_end_date ? \Carbon\Carbon::parse($banner->banner_end_date)->format('d-m-Y') : '') }}" 
                                placeholder="dd-mm-yyyy">
                        </div>
