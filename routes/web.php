...
use App\Http\Controllers\Buyer\RfqCartController;
...
Route::get('/', [HomeController::class, 'index'])->name('buyer.index');
Route::get('about-us', [HomeController::class, 'about'])->name('buyer.about');
Route::get('category/{slug}', [HomeController::class, 'subCategoryPage'])->name('buyer.sub-category-page');
Route::get('sub-category/{subCategory}/products', [HomeController::class, 'productPage'])->name('buyer.product-page');
Route::get('categories', [HomeController::class, 'categories'])->name('buyer.categories');
Route::get('sub-categories/{category}', [HomeController::class, 'subCategories'])->name('buyer.sub-categories');
Route::get('products/{subCategory}', [HomeController::class, 'productsBySubCategory'])->name('buyer.subcategory-products');
Route::get('top-products', [HomeController::class, 'topProducts'])->name('buyer.top-products');
Route::get('search-suggestions', [HomeController::class, 'searchSuggestions'])->name('buyer.search-suggestions');
Route::get('get-best-deal', [BuyRequirementController::class, 'create'])->name('buyer.get-best-deal.create');
Route::post('post-buy', [BuyRequirementController::class, 'store'])->name('buyer.post-buy.store');

// Product list with load more
Route::get('products-list', [\App\Http\Controllers\Buyer\ProductController::class, 'index'])->name('buyer.products.list-page');
Route::get('products-list/data', [\App\Http\Controllers\Buyer\ProductController::class, 'list'])->name('buyer.products.list');



Route::post('newsletter/subscribe', [\App\Http\Controllers\NewsletterController::class, 'store'])->name('newsletter.subscribe');

Route::post('rfq/submit', [\App\Http\Controllers\Buyer\RfqController::class, 'submit'])->name('buyer.rfq.submit');

Route::post('buyer/rfq-cart/add', [RfqCartController::class, 'addToCart'])->name('buyer.rfqcart.add');
